...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
  ...
  if (error) return <div>حدث خطأ اثناء جلب المهام</div>

  return (
    <DndProvider 
      backend={getBackend()} 
      options={isTouchDevice() ? backendOptions : undefined}
    >
...
type TaskColumnProps = {
  status: string;
  tasks: TaskType[]; //from the interface defined in the api.ts
          ...
          <div className='flex -space-x-[6px] overflow-hidden'>
            ...
            {task.author && (
              <Image
                ...
                src={`https://injaz-s3-images.s3.eu-north-1.amazonaws.com/${task.author.profilePictureUrl}`}
